...
if (!details.includes("versionName='0.3.10-clarity'")) throw new Error("Unexpected APK version.");
...
const versionedOutput = path.join(path.dirname(output), "nethack3d-webxr-0.3.10-clarity-debug.apk");
