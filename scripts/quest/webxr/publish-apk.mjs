...
if (!details.includes("versionName='0.3.2-live-ui'")) throw new Error("Unexpected APK version.");
...
const versionedOutput = path.join(path.dirname(output), "nethack3d-webxr-0.3.2-live-ui-debug.apk");
