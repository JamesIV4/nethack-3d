...
const fixture=await build({stdin:{resolveDir:root,contents:(await import('node:fs')).readFileSync(path.join(root,'scripts/quest/webxr/fixtures/tabletop-facing.js'),'utf8')},bundle:true,format:'iife',write:false,logLevel:'silent'});
