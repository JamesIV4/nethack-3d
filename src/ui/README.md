...
| Tile context actions and optional localhost face-rotation calibration | [tile-context flow](app/context/use-tile-context.tsx), [face rotation data](../game/engine/diagnostics/tile-face-texture-rotation-data.ts) | [TileContextMenu](app/context/TileContextMenu.tsx) |
