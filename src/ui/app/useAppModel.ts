...
export function useAppModel() {
  ...
  const {
    ...
    get tilesetManagerTileHeight() { return tilesetManagerTileHeight; },
    get setTilesetManagerTileHeight() { return setTilesetManagerTileHeight; },
    get setTilesetManagerTileDimensions() { return setTilesetManagerTileDimensions; },
