export const ru = {
  ...
  app: {
    ...
    clientOptions: {
      config: {
        ...
        soundEnabled: {
          label: "Включить звук",
          description:
            "Включить или выключить звук. Отключение уменьшает нагрузку обработки звука на слабых устройствах.",
        },
    ...
    soundPack: {
      ...
      filterPlaceholder: "Фильтровать звуки...",
      clearFilter: "Очистить фильтр",
      noMatchingSounds: "Нет звуков, соответствующих фильтру.",
      ambientDescription:
      ...
      reverbDescription:
        "Интенсивность реверберации для этого набора. Уровень для звука — это глобальная интенсивность плюс смещение текущего типа уровня плюс собственное смещение звука или трека.",
      ...
      pitchVariation: "Вариация высоты тона",
    },
    dialogs: {
      pauseMenu: {
