...
export const fr = {
  ...
  app: {
    actionCustomization: {
      savedImmediately: "Les modifications sont enregistrées immédiatement. Restaurer les valeurs par défaut réinitialise les trois dispositions de boutons.",
      customize: "Personnaliser",
      mobileHotbar: "Barre d'actions (mobile / VR)",
      desktopHotbar: "Barre d'actions (bureau)",
      menuActions: "Menu / Actions",
      buttonOrder: "Ordre des boutons",
      unavailableInGame: (label: string) => `${label} (indisponible dans cette partie)`,
      moveEarlier: (label: string) => `Déplacer ${label} vers le haut`,
      moveLater: (label: string) => `Déplacer ${label} vers le bas`,
      remove: (label: string) => `Supprimer ${label}`,
      removeButton: "Supprimer",
      noButtonsAdded: "Aucun bouton n'a encore été ajouté.",
      ...
      showHotbar: "Afficher la barre d'actions",
      hideHotbar: "Masquer la barre d'actions",
      customizeHotbar: "Personnaliser la barre d'actions",
    },
    webxr: {
      groupLabel: "Réalité virtuelle",
      passthroughLabel: "Réalité mixte en VR",
      passthroughDescription: "Affichez votre pièce autour du plateau ou du donjon. S'applique à la prochaine entrée en VR.",
      vrTabLabel: "VR",
      vrTabDescription: "Présentation du casque et paramètres de la table.",
      buttonsTabLabel: "Barre d'actions",
      buttonsTabDescription: "Personnalisez les barres d'actions et les raccourcis Menu / Actions.",
      enter: "Entrer en VR",
      exit: "Quitter la VR",
      opening: "Ouverture de la VR…",
      fpsWorldScaleLabel: "Échelle du monde FPS",
      fpsWorldScaleDescription: "Redimensionne immédiatement le monde immersif à la première personne. 100 % restaure la taille d'origine. Les contrôleurs, armes tenues et éléments d'interface gardent leur taille physique.",
      fpsScaleValue: (percent: number, isDefault: boolean) => `${percent} %${isDefault ? " (par défaut)" : ""}`,
      fpsScaleAriaValue: (percent: number, isDefault: boolean) => `${percent} pour cent${isDefault ? ", par défaut" : ""}`,
      defaultLabel: "Par défaut",
      resetFpsWorldScaleLabel: "Réinitialiser l'échelle du monde FPS à 100 pour cent",
      weaponGesturesLabel: "Gestes avec une arme",
      weaponGesturesDescription: "Faites pivoter une arme tenue pour attaquer en VR à la première personne. Revenez à une position calme avant l'attaque suivante.",
      weaponSensitivityLabel: "Sensibilité des gestes d'arme",
      weaponSensitivityDescription: "Les valeurs élevées acceptent des mouvements plus légers.",
      tabletopVisibleAreaLabel: "Zone visible de la table",
      tabletopVisibleAreaDescription: "Augmente la zone de carte affichée sur la table sans modifier la taille des tuiles.",
      tabletopWorldScaleLabel: "Échelle du monde sur la table",
      tabletopWorldScaleDescription: "Redimensionne le monde sur la table sans modifier la zone de carte visible ni la taille de l'interface.",
      renderResolutionLabel: "Résolution de rendu VR",
      renderResolutionDescription: "Les changements de résolution s'appliquent à la prochaine entrée en VR.",
      currentRenderSize: (size: string) => ` Taille de rendu actuelle : ${size}.`,
      instantMovementLabel: "Mouvement instantané",
      instantMovementDescription: "Déplacez-vous immédiatement entre les cases du donjon au lieu d'utiliser l'animation de mouvement standard à la première personne.",
      recenterWorldLabel: "Recentrer le monde",
      visibleMapAreaLabel: "Zone de carte visible",
      worldScaleLabel: "Échelle du monde",
      renderResolution: (width: number, height: number) => `${width} × ${height} pixels par œil`,
      unsupportedHost: "Cet hôte n'expose pas WebXR. Utilisez la version d'exécution WebXR.",
      noHeadset: "Aucun casque/runtime XR actif n'a été trouvé.",
      mixedRealityError: (detail: string) => `Impossible d'entrer en réalité mixte. Désactivez la réalité mixte en VR pour tester une session VR opaque. ${detail}`,
      hostQuitError: "L'hôte VR n'a pas pu quitter l'application.",
    },
    ...
    clientOptions: {
      config: {
        ...
        animatedMovement: {
          label: "Mouvement animé",
          description: "Anime le joueur et les autres créatures entre les cases dans les modes Tuiles et ASCII 3D. Le véritable mode Terminal se met toujours à jour immédiatement.",
        },
        ...
        minimapColorMode: {
          label: "Couleurs de la mini-carte",
          description: "Choisissez la palette sémantique de NetHack 3D ou les couleurs du terminal de NetHack.",
          options: {
            nethack3d: "NetHack 3D",
            terminal: "Terminal",
          },
    ...
    saves: {
      ...
      loadExisting: "Charger une sauvegarde existante",
