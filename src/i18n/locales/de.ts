...
export const deOverrides: LocaleOverrides<TranslationDictionary> = {
  ...
  app: {
    actionCustomization: {
      savedImmediately: "Änderungen werden sofort gespeichert. „Standards wiederherstellen“ setzt alle drei Tastenlayouts zurück.",
      customize: "Anpassen",
      mobileHotbar: "Hotbar (mobil / VR)",
      desktopHotbar: "Hotbar (Desktop)",
      menuActions: "Menü / Aktionen",
      buttonOrder: "Tastenreihenfolge",
      unavailableInGame: (label: string) => `${label} (in diesem Spiel nicht verfügbar)`,
      moveEarlier: (label: string) => `${label} weiter nach vorn verschieben`,
      moveLater: (label: string) => `${label} weiter nach hinten verschieben`,
      remove: (label: string) => `${label} entfernen`,
      removeButton: "Entfernen",
      noButtonsAdded: "Noch keine Tasten hinzugefügt.",
      ...
      hotbar: "Hotbar",
      showHotbar: "Hotbar anzeigen",
      hideHotbar: "Hotbar ausblenden",
      customizeHotbar: "Hotbar anpassen",
    },
    webxr: {
      groupLabel: "Virtuelle Realität",
      passthroughLabel: "Mixed Reality in VR",
      passthroughDescription: "Zeigt den Raum rund um das Spielfeld oder den Dungeon. Wirksam beim nächsten VR-Start.",
      vrTabLabel: "VR",
      vrTabDescription: "Headset-Darstellung und Tisch-Einstellungen.",
      buttonsTabLabel: "Hotbar",
      buttonsTabDescription: "Hotbars und Verknüpfungen für Menü/Aktionen anpassen.",
      enter: "VR starten",
      exit: "VR verlassen",
      opening: "VR wird geöffnet…",
      fpsWorldScaleLabel: "FPS-Weltskalierung",
      fpsWorldScaleDescription: "Skaliert die immersive Ego-Welt sofort. 100 % stellt die ursprüngliche Größe wieder her. Controller, gehaltene Waffen und UI behalten ihre physische Größe.",
      fpsScaleValue: (percent: number, isDefault: boolean) => `${percent} %${isDefault ? " (Standard)" : ""}`,
      fpsScaleAriaValue: (percent: number, isDefault: boolean) => `${percent} Prozent${isDefault ? ", Standard" : ""}`,
      defaultLabel: "Standard",
      resetFpsWorldScaleLabel: "FPS-Weltskalierung auf 100 Prozent zurücksetzen",
      weaponGesturesLabel: "Waffengesten",
      weaponGesturesDescription: "Schwinge eine gehaltene Waffe, um in der Ego-VR anzugreifen. Kehre vor dem nächsten Angriff in eine ruhige Position zurück.",
      weaponSensitivityLabel: "Empfindlichkeit der Waffengeste",
      weaponSensitivityDescription: "Höhere Werte akzeptieren leichtere Schwingungen.",
      tabletopVisibleAreaLabel: "Sichtbarer Tischbereich",
      tabletopVisibleAreaDescription: "Vergrößert den auf dem Tisch angezeigten Kartenbereich, ohne die Kachelgröße zu ändern.",
      tabletopWorldScaleLabel: "Weltskalierung auf dem Tisch",
      tabletopWorldScaleDescription: "Skaliert die Tischwelt, ohne den sichtbaren Kartenbereich oder die UI-Größe zu ändern.",
      renderResolutionLabel: "VR-Renderauflösung",
      renderResolutionDescription: "Auflösungsänderungen gelten beim nächsten VR-Start.",
      currentRenderSize: (size: string) => ` Aktuelle Rendergröße: ${size}.`,
      instantMovementLabel: "Sofortige Bewegung",
      instantMovementDescription: "Bewege dich sofort zwischen Dungeon-Kacheln, statt die normale Ego-Bewegungsanimation zu verwenden.",
      recenterWorldLabel: "Welt zentrieren",
      visibleMapAreaLabel: "Sichtbarer Kartenbereich",
      worldScaleLabel: "Weltskalierung",
      renderResolution: (width: number, height: number) => `${width} × ${height} Pixel pro Auge`,
      unsupportedHost: "Dieser Host stellt kein WebXR bereit. Verwende den WebXR-Runtime-Build.",
      noHeadset: "Kein aktives XR-Headset bzw. keine XR-Runtime gefunden.",
      mixedRealityError: (detail: string) => `Mixed Reality konnte nicht gestartet werden. Deaktiviere „Mixed Reality in VR“, um eine undurchsichtige VR-Sitzung zu testen. ${detail}`,
      hostQuitError: "Der VR-Host konnte die App nicht beenden.",
    },
