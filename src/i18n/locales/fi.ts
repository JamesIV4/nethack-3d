...
export const fiOverrides: LocaleOverrides<TranslationDictionary> = {
  ...
  app: {
    actionCustomization: {
      savedImmediately: "Muutokset tallennetaan heti. Palauta oletukset nollaa kaikki kolme painikeasettelua.",
      customize: "Mukauta",
      mobileHotbar: "Toimintopalkki (mobiili / VR)",
      desktopHotbar: "Toimintopalkki (työpöytä)",
      menuActions: "Valikko / toiminnot",
      buttonOrder: "Painikkeiden järjestys",
      unavailableInGame: (label: string) => `${label} (ei käytettävissä tässä pelissä)`,
      moveEarlier: (label: string) => `Siirrä ${label} aiemmaksi`,
      moveLater: (label: string) => `Siirrä ${label} myöhemmäksi`,
      remove: (label: string) => `Poista ${label}`,
      removeButton: "Poista",
      noButtonsAdded: "Painikkeita ei ole vielä lisätty.",
      allCommands: "Kaikki komennot",
      searchCommands: "Hae komentoja",
      searchPlaceholder: "Hae nimellä",
      add: (label: string) => `Lisää ${label}`,
      addButton: "Lisää",
      added: "Lisätty",
      noMatchingCommands: "Vastaavia komentoja ei löytynyt.",
      restoreDefaults: "Palauta oletukset",
      hotbar: "Toimintopalkki",
      showHotbar: "Näytä toimintopalkki",
      hideHotbar: "Piilota toimintopalkki",
      customizeHotbar: "Mukauta toimintopalkkia",
    },
    webxr: {
      groupLabel: "Virtuaalitodellisuus",
      passthroughLabel: "Sekoitettu todellisuus VR:ssä",
      passthroughDescription: "Näytä huoneesi pelilaudan tai luolaston ympärillä. Tulee voimaan, kun siirryt seuraavan kerran VR:ään.",
      vrTabLabel: "VR",
      vrTabDescription: "Lasisuojanäkymän ja pöydän asetukset.",
      buttonsTabLabel: "Toimintopalkki",
      buttonsTabDescription: "Mukauta toimintopalkkeja ja Valikko / toiminnot -pikavalintoja.",
      enter: "Siirry VR:ään",
      exit: "Poistu VR:stä",
      opening: "Avataan VR:ää...",
      fpsWorldScaleLabel: "FPS-maailman skaala",
      fpsWorldScaleDescription: "Muuta immersiivisen ensimmäisen persoonan maailman kokoa heti. 100 % palauttaa alkuperäisen koon. Ohjaimet, kädessä olevat aseet ja käyttöliittymä säilyttävät fyysisen kokonsa.",
      fpsScaleValue: (percent: number, isDefault: boolean) => `${percent} %${isDefault ? " (oletus)" : ""}`,
      fpsScaleAriaValue: (percent: number, isDefault: boolean) => `${percent} prosenttia${isDefault ? ", oletus" : ""}`,
      defaultLabel: "Oletus",
      resetFpsWorldScaleLabel: "Palauta FPS-maailman skaala 100 prosenttiin",
      weaponGesturesLabel: "Ase-eleet",
      weaponGesturesDescription: "Hyökkää heilauttamalla kädessä olevaa asetta ensimmäisen persoonan VR:ssä. Palaa rauhalliseen asentoon ennen seuraavaa hyökkäystä.",
      weaponSensitivityLabel: "Ase-eleiden herkkyys",
      weaponSensitivityDescription: "Suuremmat arvot hyväksyvät kevyemmät heilautukset.",
      tabletopVisibleAreaLabel: "Pöydän näkyvä alue",
      tabletopVisibleAreaDescription: "Kasvata pöydällä näytettävää kartta-aluetta muuttamatta ruutujen kokoa.",
      tabletopWorldScaleLabel: "Pöytämaailman skaala",
      tabletopWorldScaleDescription: "Muuta pöytämaailman kokoa muuttamatta näkyvää kartta-aluetta tai käyttöliittymän kokoa.",
      renderResolutionLabel: "VR-renderöinnin tarkkuus",
      renderResolutionDescription: "Tarkkuuden muutokset tulevat voimaan seuraavan VR-siirtymän yhteydessä.",
      currentRenderSize: (size: string) => ` Nykyinen renderöintikoko: ${size}.`,
      instantMovementLabel: "Välitön liike",
      instantMovementDescription: "Siirry heti luolaston ruutujen välillä tavallisen ensimmäisen persoonan liikeanimaation sijaan.",
      recenterWorldLabel: "Keskitä maailma",
      visibleMapAreaLabel: "Näkyvä kartta-alue",
      worldScaleLabel: "Maailman skaala",
      renderResolution: (width: number, height: number) => `${width} × ${height} pikseliä silmää kohden`,
      unsupportedHost: "Tämä isäntä ei tarjoa WebXR:ää. Käytä WebXR-ajonaikaversiota.",
      noHeadset: "Aktiivista XR-lasia tai -ajonaikaa ei löytynyt.",
      mixedRealityError: (detail: string) => `Sekoitettua todellisuutta ei voitu käynnistää. Poista Sekoitettu todellisuus VR:ssä käytöstä testataksesi peittävää VR-istuntoa. ${detail}`,
      hostQuitError: "VR-isäntä ei voinut sulkea sovellusta.",
    },
