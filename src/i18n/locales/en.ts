export const en = {
  ...
  soundEffects: {
    byKey: {
      ...
      "door-trap-explodes": "Door trap explodes",
      "wand-glow-fade": "Wand glows and fades",
      "action-no-effect": "Nothing happens",
      "container-glass-shatter": "Container contents shatter (kick)",
      "container-egg-crack": "Container egg cracks (kick)",
      "container-glass-crash": "Container glass crashes (off-level)",
      "container-item-splat": "Container item splats (off-level)",
      "trap-arrow": "Arrow trap",
      "trap-dart": "Dart trap",
      "trap-bear": "Bear trap",
      "trap-land-mine": "Land mine",
      "trap-rolling-boulder": "Rolling boulder trap",
      "trap-sleeping-gas": "Sleeping gas trap",
      "trap-rust": "Rust trap",
      "trap-spiked-pit": "Spiked pit",
      "trap-squeaky-board": "Squeaky board",
      "trap-magic-explosion": "Magic trap explosion",
      "trap-hole": "Trap door / hole",
      "trap-web": "Caught in spider web",
      "trap-statue-life": "Statue comes to life",
      "item-shatters": "Item shatters",
      "thrown-splat": "Egg/melon splat",
      "thrown-cream-pie": "Cream pie hit",
      "combat-digested": "Digested by monster",
      "combat-regurgitated": "Regurgitated",
      "combat-slimed": "Slimed",
      "combat-knocked-back": "Knocked back",
      "weapon-poison-fades": "Poison fades from weapon",
      "status-blinded-flash": "Blinded by flash",
      "status-blinded-hit": "Blinded by attack",
      "status-frozen": "Frozen in place",
      "status-petrify-progress": "Turning to stone",
      "status-choking": "Choking",
      "status-sickness-worsens": "Sickness worsens",
      "status-vomit": "Vomiting",
      "status-poison-deadly": "Poison proves deadly",
      "status-poison-resist": "Poison resisted",
      "status-poison-dishonorable": "Dishonorable poison use",
      "status-feverish": "Feverish (lycanthropy)",
      "death-drown": "Drowning",
      "death-burning": "Still burning",
      "death-stone": "Turn to stone (death)",
      "death-sink-surface": "Sink and drown",
      "death-disintegrate-self": "Self-disintegration",
      "danger-fall-asleep": "Sudden sleep",
      "death-generic": "Death",
      "death-illness": "Death by illness",
      "prayer-begin": "Begin praying",
      "prayer-finish": "Finish praying",
      "prayer-pleased": "God is pleased",
      "prayer-angered": "God is angered",
      "prayer-lightning-strike": "Lightning strike (wrath)",
      "prayer-disintegration-beam": "Disintegration beam (wrath)",
      "prayer-fry-crisp": "Fried by wrath",
      "prayer-crown-lawful": "Crowned Hand of Elbereth",
      "prayer-crown-neutral": "Crowned Envoy of Balance",
      "prayer-immortality": "Granted immortality",
      "prayer-reject-sacrifice": "Sacrifice rejected",
      "prayer-accept-allegiance": "Allegiance accepted",
      "prayer-altar-glow": "Altar glow",
      "prayer-sacrifice-consumed": "Sacrifice consumed",
      "prayer-sacrifice-betrayal": "Sacrifice betrayal",
      "prayer-altar-desecrate": "Altar desecration wrath",
      "prayer-ascend-demigod": "Ascend to demigod",
      "wizard-voice": "Wizard's voice",
      "wand-explodes": "Wand explodes",
      "wand-last-charge": "Wand's last charge",
      "scroll-punishment": "Scroll of punishment",
      "scroll-fire": "Scroll of fire",
      "scroll-genocide-found": "Found scroll of genocide",
      "scroll-stinking-cloud-found": "Found scroll of stinking cloud",
      "scroll-amnesia": "Scroll of amnesia",
      "scroll-create-monster": "Scroll of create monster",
      "scroll-magic-mapping": "Scroll of magic mapping",
      "scroll-confuse-mind": "Cursed mind confusion",
      "potion-gain-level": "Potion of gain level",
      "potion-sickness": "Potion of sickness",
      "potion-gain-energy": "Potion of gain energy",
      "potion-blindness": "Potion of blindness",
      "djinni-emerges": "Djinni emerges",
      "djinni-grants-wish": "Djinni grants wish",
      "wish-prompt": "Wish prompt",
      "amulet-strangle-on": "Amulet of strangulation",
      "amulet-strangle-relief": "Strangulation relief",
      "mirror-no-reflection": "No reflection",
      "mirror-self-freeze": "Mirror self-freeze",
      "shop-alarm": "Shop alarm",
      "shop-kops-appear": "Keystone Kops appear",
      "shop-escape-no-pay": "Escape shop unpaid",
      "shop-keeper-attacks": "Shopkeeper attacks",
      "shop-thank-you": "Shopkeeper thanks you",
      "shop-debt-paid": "Shop debt paid",
      "shop-item-free": "Item for free",
      "pet-leash-breaks": "Pet leash breaks",
      "pet-leash-chokes": "Pet leash chokes",
      "pet-dies-offscreen": "Pet dies offscreen",
      "steed-mount": "Mount steed",
      "steed-thrown-off": "Thrown from steed",
      "monster-grows-up": "Monster grows up",
      "dig-ceiling-collapse": "Ceiling collapse (dig)",
      "dig-boulder-falls-in": "Boulder falls in hole",
      "dig-disturb-grave": "Disturb grave",
      "dig-vandal-arrest": "Arrested for vandalism",
      "fountain-bubbles": "Fountain bubbles",
      "fountain-dries-up": "Fountain dries up",
      "fountain-overflows": "Fountain overflows",
      "fountain-disappears": "Fountain disappears",
      "fountain-gem-spotted": "Gem spotted in fountain",
      "fountain-snakes": "Fountain snakes",
      "fountain-demon-wish": "Water demon wish",
      "fountain-excalibur-blessed": "Excalibur blessed",
      "sink-pipes-break": "Sink pipes break",
      "sink-find-ring": "Ring found in sink",
      "sink-sewage-vomit": "Sink sewage vomit",
      "throne-puff-of-logic": "Throne vanishes",
      "throne-electric-shock": "Throne electric shock",
      "throne-acid": "Throne acid",
      "throne-warp": "Throne warps you",
      "throne-insight": "Throne insight",
      "throne-terrible-experience": "Throne terrible experience",
      "levitation-start": "Start levitating",
      "web-tear-free": "Tear through web",
      "boulder-crash-door": "Boulder crashes through door",
      "invocation-vibration": "Invocation vibration",
      "engrave-wand-digging": "Identify wand of digging",
      "engrave-wand-fire": "Identify wand of fire",
      "engrave-wand-lightning": "Identify wand of lightning",
      "engrave-flames-fly": "Engrave flames",
      "engrave-lightning-arcs": "Engrave lightning",
      "engrave-disturb-undead": "Engrave disturbs undead",
      "engrave-message-dissolves": "Engraving dissolves",
      "engrave-vanishes": "Engraving vanishes",
      "engrave-wipe-message": "Wipe engraving",
      "engrave-room-full": "Out of engraving room",
      "jump-fails": "Jump fails",
      "jump-rip-bear-trap": "Rip free of bear trap",
      "jump-leap-pit": "Leap from pit",
      "teleport-attempt-spell": "Attempt teleport spell",
      "teleport-spell-fails": "Teleport spell fails",
      // Being hit by monster — by attack type
      "hit-by-bite": "Hit by: bite (monster bites you)",
      "hit-by-kick": "Hit by: kick (monster kicks you)",
      "hit-by-sting": "Hit by: sting (monster stings you)",
      "hit-by-headbutt": "Hit by: head-butt (monster butts you)",
      "hit-by-touch": "Hit by: touch attack",
      "hit-by-mind-flayer-tentacle": "Hit by: mind flayer tentacles (brain drain)",
      "hit-by-monster-self-destructs": "Hit by: monster explodes on you",
      "hit-by-engulf": "Hit by: swallowed or engulfed",
      "hit-by-venom-spit": "Hit by: venom spit",
      "hit-by-breath-weapon": "Hit by: breath weapon (fire, cold, etc.)",
      "hit-by-weapon-swing": "Hit by: weapon swing (monster wields a weapon)",
      "hit-by-claw-or-weapon": "Hit by: claw or weapon (generic physical hit)",
      // Hitting a monster — pain/reaction sound by monster class
      "pain-ant": "Pain: ants & insects (giant ant, killer bee, etc.)",
      "pain-blob": "Pain: blobs (acid blob, gelatinous cube)",
      "pain-cockatrice": "Pain: cockatrices & pyrolisk",
      "pain-canine": "Pain: dogs & wolves (jackal, wolf, hell hound, etc.)",
      "pain-eye": "Pain: eyes & spheres (floating eye, beholder, etc.)",
      "pain-feline": "Pain: cats & felines (kitten, tiger, etc.)",
      "pain-gremlin": "Pain: gremlins & gargoyles",
      "pain-humanoid-small": "Pain: small humanoids (dwarf, hobbit, mind flayer)",
      "pain-imp": "Pain: imps & minor demons (imp, quasit, tengu, etc.)",
      "pain-jelly": "Pain: jellies (blue jelly, ochre jelly)",
      "pain-kobold": "Pain: kobolds",
      "pain-leprechaun": "Pain: leprechauns",
      "pain-mimic": "Pain: mimics",
      "pain-nymph": "Pain: nymphs (wood, water, mountain)",
      "pain-orc": "Pain: orcs & goblins (goblin, orc, Uruk-hai, etc.)",
      "pain-piercer": "Pain: piercers",
      "pain-quadruped": "Pain: quadrupeds (rothe, mastodon, etc.)",
      "pain-rodent": "Pain: rats & rodents (sewer rat, wererat, etc.)",
      "pain-arachnid": "Pain: spiders & centipedes (cave spider, scorpion, etc.)",
      "pain-trapper": "Pain: trappers & lurkers above",
      "pain-equine": "Pain: horses & unicorns",
      "pain-vortex": "Pain: vortices (fog cloud, fire vortex, etc.)",
      "pain-worm": "Pain: worms (long worm, purple worm)",
      "pain-xan": "Pain: grid bugs & xan",
      "pain-light": "Pain: lights (yellow light, black light)",
      "pain-zruty": "Pain: zruty",
      "pain-angel": "Pain: angels (couatl, Archon, ki-rin, etc.)",
      "pain-bat": "Pain: bats & birds (bat, raven, vampire bat)",
      "pain-centaur": "Pain: centaurs",
      "pain-dragon": "Pain: dragons (all colors, baby & adult)",
      "pain-elemental": "Pain: elementals (fire, water, air, earth, stalker)",
      "pain-fungus": "Pain: fungi & molds (lichen, shrieker, etc.)",
      "pain-gnome": "Pain: gnomes",
      "pain-giant": "Pain: giants & minotaurs (hill giant, ettin, Cyclops, etc.)",
      "pain-jabberwock": "Pain: jabberwocks",
      "pain-kop": "Pain: Keystone Kops",
      "pain-lich": "Pain: liches (lich, demilich, arch-lich)",
      "pain-mummy": "Pain: mummies (kobold, orc, giant, etc.)",
      "pain-naga": "Pain: nagas (red, black, golden, guardian)",
      "pain-ogre": "Pain: ogres",
      "pain-ooze": "Pain: puddings & slimes (black pudding, green slime)",
      "pain-quantum-mechanic": "Pain: quantum mechanics",
      "pain-rust-monster": "Pain: rust monsters & disenchanters",
      "pain-snake": "Pain: snakes (garter snake, cobra, etc.)",
      "pain-troll": "Pain: trolls (ice, rock, water troll, etc.)",
      "pain-umber-hulk": "Pain: umber hulks",
      "pain-vampire": "Pain: vampires (Vlad the Impaler, etc.)",
      "pain-wraith": "Pain: wraiths (barrow wight, Nazgul)",
      "pain-xorn": "Pain: xorns",
      "pain-yeti": "Pain: yetis & apes (owlbear, sasquatch, etc.)",
      "pain-zombie": "Pain: zombies (all species, plus skeleton & ghoul)",
      "pain-human": "Pain: humans & elves (soldiers, Medusa, role classes, etc.)",
      "pain-ghost": "Pain: ghosts & shades",
      "pain-golem": "Pain: golems (iron, stone, flesh, etc.)",
      "pain-demon": "Pain: major demons (Asmodeus, Demogorgon, the Riders, etc.)",
      "pain-sea-monster": "Pain: sea monsters (shark, kraken, electric eel, etc.)",
      "pain-lizard": "Pain: lizards & crocodiles",
    },
  },
  ambientTracks: {
    byKey: {
  ...
  app: {
    ...
    soundPack: {
      ...
      matchInfoAria: (label: string) => `Which game log text triggers ${label}`,
      matchInfoHeading: "Plays when the game log line matches:",
