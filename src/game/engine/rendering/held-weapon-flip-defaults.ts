import type { FpsHeldWeaponTileFlipOverridesByTileset } from "../shared/types";

/** Per-sprite corrections authored by npm run weapon:calibrate; shared by flat FPS and VR. */
export const authoredHeldWeaponTileFlips: FpsHeldWeaponTileFlipOverridesByTileset = {
