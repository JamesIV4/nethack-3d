...
export function tabletopClippingPlanes(player: THREE.Vector3, tileSize: number): THREE.Plane[] {
  return [
    new THREE.Plane(new THREE.Vector3(1, 0, 0), -player.x + tileSize * 12.5),
    new THREE.Plane(new THREE.Vector3(-1, 0, 0), player.x + tileSize * 12.5),
    new THREE.Plane(new THREE.Vector3(0, 1, 0), -player.y + tileSize * 8.5),
    new THREE.Plane(new THREE.Vector3(0, -1, 0), player.y + tileSize * 8.5),
  ];
}
