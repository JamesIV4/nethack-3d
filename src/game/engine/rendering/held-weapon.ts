import { flipHeldWeaponTexture } from "./held-weapon-texture";
...
import {
  ...
  FPS_HELD_WEAPON_BASE_LOCAL_OFFSET,
...
export class HeldWeapon {
  ...
  createFpsHeldWeaponFlippedTexture(
    ...
    if (!flipState.flipX && !flipState.flipY && !flipState.flipDiagonal) return texture;
    return flipHeldWeaponTexture(texture, flipState,
